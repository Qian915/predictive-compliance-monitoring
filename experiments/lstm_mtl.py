...
from tensorflow.keras.layers import Input, Bidirectional, LSTM, Dropout, Dense, Attention, GlobalAveragePooling1D, Concatenate
...
for dataset_name in datasets:
    ...
    #model.compile(
        ...
        #}
    #)
    early_stopping = EarlyStopping(monitor='val_loss', patience=10, restore_best_weights=True)       #TODO define early stoppping with patience of 5 to avoid over-fitting
    #model.summary()
